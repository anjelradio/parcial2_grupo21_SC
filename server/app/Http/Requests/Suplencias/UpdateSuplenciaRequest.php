...
class UpdateSuplenciaRequest extends FormRequest
{
    public function authorize(): bool
    {
        // Solo ADMIN o AUTORIDAD pueden actualizar suplencias
        $user = $this->user();
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'id_asignacion' => [
                ...
                // Permitir la misma asignación si es la suplencia actual
                Rule::unique('suplencia', 'id_asignacion')->ignore($suplenciaId, 'id_suplencia')
            ],
