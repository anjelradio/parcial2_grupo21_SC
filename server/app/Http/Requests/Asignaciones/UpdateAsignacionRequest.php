...
class UpdateAsignacionRequest extends FormRequest
{
    ...
    {
        $idAsignacion = $this->route('id'); // <-- AGREGAR ESTA LÍNEA
    ...
    $query->whereHas('asignacion', function ($q) use ($idGestion, $codigoDocente, $idGrupo, $idAsignacion) { // <-- AGREGAR $idAsignacion
